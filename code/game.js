...
var WwobbleSpeed =0.1;
var WwobbleDist =0.1;
Warp.prototype.act= function(step, level){
  this.wobble += step * WwobbleSpeed;
  var wobblePos = Math.sin(this.wobble)* WwobbleDist;
...
function runGame(plans, Display) {
  function startLevel(n) {
        ...
        image.src= 'http://m.memegen.com/icj089.jpg';
        var source = document.getElementById('Resualts');
